...
# Dataset will be loaded when training starts to keep GUI responsive.
...
class Ui_MainWindow(object):
    ...
    def trainingFunction(self):
        ...
        self.textEdit.setText("Loading Dataset & Training...")
        QtWidgets.QApplication.processEvents() # Ensure text updates
        ...
        for i in range(classes):
            path = os.path.join(cur_path,'dataset/Train/',str(i)) # Note: Zip might have 'Train' capitalized
        ...
        if not data:
            self.textEdit.setText("Error: Dataset folder not found or empty.")
            return
